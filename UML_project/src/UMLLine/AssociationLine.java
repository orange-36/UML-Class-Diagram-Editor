...
public class AssociationLine extends BaseLine {
    public AssociationLine(BaseObject source, Point originalPoint, Point currentPoint) {
        super(source, originalPoint, currentPoint);
    }

    public AssociationLine(BaseObject source, Point originalPoint, BaseObject destination,
            Point currentPoint) {
